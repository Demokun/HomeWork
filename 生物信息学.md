...
.syntax--source.syntax--python .syntax--variable.syntax--parameter {
  ...
  <body class='markdown-preview' data-use-github-style><h1 id="-">生物基础</h1>
<h2 id="dna-deoxyribonucleic-acid-">DNA（deoxyribonucleic acid）</h2>
<h2 id="rna">RNA</h2>
<h2 id="-">蛋白质</h2>
<h2 id="-">中心法则</h2>
<p>遗传信息经过DNA转录成RNA（mRNA），再由转运RNA（tRNA）和核糖体将mRNA翻译成蛋白质</p>
<p>DNA -&gt; DNA    </p>
<p>DNA -&gt; RNA</p>
<p>RNA -&gt; 蛋白质</p>
<h1 id="-bioinformatics-">生物信息学 (bioinformatics)</h1>
<hr>
